...
With the zip file you downloaded, run the code below to reproduce the datamation gifs. (`eval=FALSE` in chunk options might prevent you from automatically running the chuncks. Remove if necessary.)
