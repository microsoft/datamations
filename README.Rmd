...
datamation_sanddance(test_pipe, output = "mean_salary_group_by_degree.gif")

plot_pipe2 <- "small_salary %>% group_by(Degree, Work) %>% summarize(mean = mean(Salary))"

datamation_sanddance(test_pipe2, output = "mean_salary_group_by_degree_work.gif")

```

Using internal function calls 
